#!/usr/bin/python
"""
Borrowed by Roman Garcia from clburlison on 06.06.2017 for use at ...

This script performs the following operations:

1. Enables Location Services from macOS 10.8 forward (tested up to macOS 10.12.5)
2. Enables "Set time zone automatically using current location"
3. Forces a time zone location lookup at runtime
4. Sets correct date, time, and time zone

The script can also set NTP servers (commented out at this time).

This script has a bunch of stolen work from @arubdesu, @pudquick, and Munki. See:
